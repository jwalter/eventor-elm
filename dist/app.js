...
var _jwalter$eventor_elm$ApiKey$value = 'cb39d7ba1e6f436cafacd2f5d26ecd12';

var _jwalter$eventor_elm$JsonSupport$insideList = F2(
	function (collectorStart, listItemDecoder) {
		return A2(
			_elm_lang$core$Json_Decode$map,
			function (aList) {
				return A3(
					_elm_lang$core$List$foldr,
					F2(
						function (itemInList, accumulated) {
							return itemInList;
						}),
					collectorStart,
					aList);
			},
			_elm_lang$core$Json_Decode$list(listItemDecoder));
	});

var _jwalter$eventor_elm$Race$nameDecoder = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
...
var _jwalter$eventor_elm$Race$Race = F3(
	function (a, b, c) {
		return {name: a, startDate: b, position: c};
	});
var _jwalter$eventor_elm$Race$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _jwalter$eventor_elm$Race$empty = A3(
	_jwalter$eventor_elm$Race$Race,
	'',
	'',
	A2(_jwalter$eventor_elm$Race$Point, '', ''));
var _jwalter$eventor_elm$Race$pointDecoder = A3(
	...
	A3(
		...
		'x',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jwalter$eventor_elm$Race$Point)));
var _jwalter$eventor_elm$Race$decoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'EventCenterPosition',
	A2(
		_jwalter$eventor_elm$JsonSupport$insideList,
		A2(_jwalter$eventor_elm$Race$Point, '', ''),
		A2(
			_elm_lang$core$Json_Decode$at,
			_elm_lang$core$Native_List.fromArray(
				['$']),
			_jwalter$eventor_elm$Race$pointDecoder)),
	A2(_jwalter$eventor_elm$Race$Point, '', ''),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'RaceDate',
		A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					['Date']),
				A2(_jwalter$eventor_elm$JsonSupport$insideList, '', _elm_lang$core$Json_Decode$string))),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'Name',
			A2(_jwalter$eventor_elm$JsonSupport$insideList, '', _jwalter$eventor_elm$Race$nameDecoder),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jwalter$eventor_elm$Race$Race))));
var _jwalter$eventor_elm$Race$raceFromJson = A2(_elm_lang$core$Json_Decode$decodeString, _jwalter$eventor_elm$Race$decoder, '\n        {\n          \"$\": {\n            \"raceLightCondition\": \"Day\",\n            \"raceDistance\": \"Long\"\n          },\n          \"EventRaceId\": [\n            \"12918\"\n          ],\n          \"EventId\": [\n            \"12215\"\n          ],\n          \"Name\": [\n            {\n              \"_\": \"Etapp 1, lång\",\n              \"$\": {\n                  \"languageId\": \"sv\"\n              }\n            }\n          ],\n          \"RaceDate\": [\n            {\n              \"Date\": [\n                \"2016-07-04\"\n              ],\n              \"Clock\": [\n                \"00:00:00\"\n              ]\n            }\n          ],\n          \"EventCenterPosition\": [\n            {\n              \"$\": {\n                \"y\": \"59.28825\",\n                \"x\": \"18.16078\"\n              }\n            }\n          ]\n        }\n        ');
var _jwalter$eventor_elm$Race$main = {
	main: function () {
		var race = _jwalter$eventor_elm$Race$raceFromJson;
		var _p0 = race;
		if (_p0.ctor === 'Ok') {
...
var _jwalter$eventor_elm$Competition$Competition = F3(
	function (a, b, c) {
		return {name: a, startDate: b, races: c};
	});
var _jwalter$eventor_elm$Competition$empty = A3(
	_jwalter$eventor_elm$Competition$Competition,
	'',
	'',
	_elm_lang$core$Native_List.fromArray(
		[]));
var _jwalter$eventor_elm$Competition$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'EventRace',
	_elm_lang$core$Json_Decode$list(_jwalter$eventor_elm$Race$decoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'StartDate',
		A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						['_']),
					_elm_lang$core$Json_Decode$string)),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jwalter$eventor_elm$Competition$Competition))));
var _jwalter$eventor_elm$Competition$decodedName = A2(_elm_lang$core$Json_Decode$decodeString, _jwalter$eventor_elm$Competition$decoder, '\n        {\n          \"$\": {\n            \"eventForm\": \"IndSingleDay\"\n          },\n          \"EventId\": [ \"10936\" ],\n          \"Name\": [{\n            \"_\": \"SOK Nordiska, medeldistans\",\n            \"$\": { \"languageId\": \"sv\" }\n          }],\n          \"StartDate\": [{\n            \"Date\": [\"2016-07-02\"],\n            \"Clock\": [\"00:00:00\"]\n          }],\n          \"EventRace\": [\n          {\n            \"$\": {\n              \"raceLightCondition\": \"Day\",\n              \"raceDistance\": \"Long\"\n            },\n            \"EventRaceId\": [\n              \"12918\"\n            ],\n            \"EventId\": [\n              \"12215\"\n            ],\n            \"Name\": [\n              {\n                \"_\": \"Etapp 1, lång\",\n                \"$\": {\n                  \"languageId\": \"sv\"\n                }\n              }\n            ],\n            \"RaceDate\": [\n              {\n                \"Date\": [\n                  \"2016-07-04\"\n                ],\n                \"Clock\": [\n                  \"00:00:00\"\n                ]\n              }\n            ],\n            \"EventCenterPosition\": [\n              {\n                \"$\": {\n                  \"y\": \"59.28825\",\n                  \"x\": \"18.16078\"\n                }\n              }\n            ]\n            }\n            ]\n        }\n        ');
var _jwalter$eventor_elm$Competition$main = {
	main: function () {
		var name = _jwalter$eventor_elm$Competition$decodedName;
		var _p0 = name;
		if (_p0.ctor === 'Ok') {
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p0._0));
...
var _jwalter$eventor_elm$Eventor$fetchData = function (url) {
	return A2(
		...
		_evancz$elm_http$Http$defaultSettings,
		{
			...
			headers: _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'apikey', _1: _jwalter$eventor_elm$ApiKey$value}
				]),
			url: url,
			body: _evancz$elm_http$Http$empty
		});
...
var _jwalter$eventor_elm$Main$httpErrorMessage = function (error) {
	var _p0 = error;
	switch (_p0.ctor) {
		case 'Timeout':
			return 'Timeout';
...
var _jwalter$eventor_elm$Main$decodeUrlResponse = F2(
	function (url, decoder) {
		return A2(
			_evancz$elm_http$Http$fromJson,
			decoder,
			_jwalter$eventor_elm$Eventor$fetchData(url));
	});
var _jwalter$eventor_elm$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _jwalter$eventor_elm$Main$memberView = function (member) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.name)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.startDate)
					]))
			]));
};
var _jwalter$eventor_elm$Main$mergeNames = F2(
	function (competition, race) {
		var name = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(race.name),
			0) > 0) ? A2(
			_elm_lang$core$Basics_ops['++'],
			competition.name,
			A2(_elm_lang$core$Basics_ops['++'], ', ', race.name)) : competition.name;
		return _elm_lang$core$Native_Utils.update(
			race,
			{name: name});
	});
var _jwalter$eventor_elm$Main$allRaces = function (competitions) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (c, all) {
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_jwalter$eventor_elm$Main$mergeNames(c),
						c.races));
			}),
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _jwalter$eventor_elm$Main$view = function (competitions) {
	var races = _jwalter$eventor_elm$Main$allRaces(competitions);
	var sorted = A2(
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Tävlingar')
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$toString(
								_elm_lang$core$List$length(sorted)))
						]))
				]),
			A2(
				_elm_lang$core$List$map,
				function (m) {
					return _jwalter$eventor_elm$Main$memberView(m);
				},
				sorted)));
};
var _jwalter$eventor_elm$Main$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _jwalter$eventor_elm$Main$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _jwalter$eventor_elm$Main$loadEventorData = F2(
	function (path, decoder) {
		var url = A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:8080/api/', path);
		return A3(
			_elm_lang$core$Task$perform,
			_jwalter$eventor_elm$Main$FetchFail,
			_jwalter$eventor_elm$Main$FetchSucceed,
			A2(_jwalter$eventor_elm$Main$decodeUrlResponse, url, decoder));
	});
var _jwalter$eventor_elm$Main$loadEventorCompetitions = function () {
	var path = 'events?fromDate=2016-06-28&toDate=2016-07-30&classificationIds=1,2,3,6';
	return A2(
		_jwalter$eventor_elm$Main$loadEventorData,
		path,
		A2(
			_elm_lang$core$Json_Decode$at,
			_elm_lang$core$Native_List.fromArray(
				['EventList', 'Event']),
			_elm_lang$core$Json_Decode$list(_jwalter$eventor_elm$Competition$decoder)));
}();
var _jwalter$eventor_elm$Main$init = {
	ctor: '_Tuple2',
	_0: _elm_lang$core$Native_List.fromArray(
		[]),
	_1: _jwalter$eventor_elm$Main$loadEventorCompetitions
};
var _jwalter$eventor_elm$Main$update = F2(
	function (msg, org) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'MorePlease':
				return {ctor: '_Tuple2', _0: org, _1: _jwalter$eventor_elm$Main$loadEventorCompetitions};
			case 'FetchSucceed':
			...
			default:
				return {
					...
					_0: A2(
						...
						_jwalter$eventor_elm$Main$httpErrorMessage(_p1._0),
						org),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _jwalter$eventor_elm$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _jwalter$eventor_elm$Main$init, view: _jwalter$eventor_elm$Main$view, update: _jwalter$eventor_elm$Main$update, subscriptions: _jwalter$eventor_elm$Main$subscriptions})
};
var _jwalter$eventor_elm$Main$MorePlease = {ctor: 'MorePlease'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _jwalter$eventor_elm$Main$main === 'undefined' ? null : _jwalter$eventor_elm$Main$main);
