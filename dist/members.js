...
var _jwalter$project$ApiKey$value = 'cb39d7ba1e6f436cafacd2f5d26ecd12';

var _jwalter$project$Eventor$fetchData = function (url) {
	return A2(
		...
		_evancz$elm_http$Http$defaultSettings,
		{
			...
			headers: _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'apikey', _1: _jwalter$project$ApiKey$value}
				]),
			url: url,
			body: _evancz$elm_http$Http$empty
		});
...
var _jwalter$project$JsonSupport$insideList = F2(
...
var _jwalter$project$PersonName$PersonName = F2(
	function (a, b) {
		return {family: a, given: b};
	});
var _jwalter$project$PersonName$empty = A2(_jwalter$project$PersonName$PersonName, '', '');
var _jwalter$project$PersonName$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'Given',
	A2(
		_jwalter$project$JsonSupport$insideList,
		'',
		A2(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'Family',
		A2(_jwalter$project$JsonSupport$insideList, '', _elm_lang$core$Json_Decode$string),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jwalter$project$PersonName$PersonName)));
var _jwalter$project$PersonName$decodedName = A2(_elm_lang$core$Json_Decode$decodeString, _jwalter$project$PersonName$decoder, '\n          {\n            \"Family\": [\n              \"Pettersson\"\n            ],\n            \"Given\": [\n              {\n                \"_\": \"Henrik\",\n                \"$\": {\n                  \"sequence\": \"1\"\n                }\n              }\n            ]\n          }\n        ');
var _jwalter$project$PersonName$main = {
	main: function () {
		var name = _jwalter$project$PersonName$decodedName;
		var _p0 = name;
		if (_p0.ctor === 'Ok') {
...
var _jwalter$project$Person$phoneNumberDecoder = A2(
	_elm_lang$core$Json_Decode_ops[':='],
	'$',
	_elm_lang$core$Json_Decode$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Json_Decode_ops[':='], 'phoneNumber', _elm_lang$core$Json_Decode$string),
				_elm_lang$core$Json_Decode$succeed('')
			])));
var _jwalter$project$Person$Person = F4(
	function (a, b, c, d) {
		return {name: a, birthDate: b, phoneNumber: c, mailAddress: d};
	});
var _jwalter$project$Person$empty = A4(_jwalter$project$Person$Person, _jwalter$project$PersonName$empty, '', '', '');
var _jwalter$project$Person$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'Tele',
	A2(
		_jwalter$project$JsonSupport$insideList,
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'Tele',
		A2(_jwalter$project$JsonSupport$insideList, '', _jwalter$project$Person$phoneNumberDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'BirthDate',
			A2(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'PersonName',
				A2(_jwalter$project$JsonSupport$insideList, _jwalter$project$PersonName$empty, _jwalter$project$PersonName$decoder),
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jwalter$project$Person$Person)))));

var _jwalter$project$PersonList$PersonList = function (a) {
	return {persons: a};
};
var _jwalter$project$PersonList$empty = _jwalter$project$PersonList$PersonList(
	_elm_lang$core$Native_List.fromArray(
		[]));
var _jwalter$project$PersonList$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'Person',
	_elm_lang$core$Json_Decode$list(_jwalter$project$Person$decoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jwalter$project$PersonList$PersonList));

var _jwalter$project$Main$httpErrorMessage = function (error) {
	var _p0 = error;
	switch (_p0.ctor) {
		case 'Timeout':
			return 'Timeout';
...
var _jwalter$project$Main$decodeUrlResponse = F2(
	function (url, decoder) {
		return A2(
			_evancz$elm_http$Http$fromJson,
			decoder,
			_jwalter$project$Eventor$fetchData(url));
	});
var _jwalter$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _jwalter$project$Main$memberView = function (member) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.name.given)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.name.family)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.birthDate)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.phoneNumber)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(member.mailAddress)
					]))
			]));
};
var _jwalter$project$Main$view = function (org) {
	var sortedMembers = A2(
		_elm_lang$core$List$sortBy,
		function (m) {
			return A2(_elm_lang$core$Basics_ops['++'], m.name.family, m.name.given);
		},
		org.persons);
	return A2(
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Medlemmar')
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$toString(
								_elm_lang$core$List$length(sortedMembers)))
						]))
				]),
			A2(
				_elm_lang$core$List$map,
				function (m) {
					return _jwalter$project$Main$memberView(m);
				},
				sortedMembers)));
};
var _jwalter$project$Main$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _jwalter$project$Main$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _jwalter$project$Main$loadEventorData = F2(
	function (path, decoder) {
		var url = A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:8080/api/', path);
		return A3(
			_elm_lang$core$Task$perform,
			_jwalter$project$Main$FetchFail,
			_jwalter$project$Main$FetchSucceed,
			A2(_jwalter$project$Main$decodeUrlResponse, url, decoder));
	});
var _jwalter$project$Main$loadEventorPersonList = function () {
	var path = 'persons/organisations/512?includeContactDetails=true';
	return A2(
		_jwalter$project$Main$loadEventorData,
		path,
		A2(
			_elm_lang$core$Json_Decode$at,
			_elm_lang$core$Native_List.fromArray(
				['PersonList']),
			_jwalter$project$PersonList$decoder));
}();
var _jwalter$project$Main$init = {ctor: '_Tuple2', _0: _jwalter$project$PersonList$empty, _1: _jwalter$project$Main$loadEventorPersonList};
var _jwalter$project$Main$update = F2(
	function (msg, org) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'MorePlease':
				return {ctor: '_Tuple2', _0: org, _1: _jwalter$project$Main$loadEventorPersonList};
			case 'FetchSucceed':
			...
			default:
				return {
					...
					_0: A2(
						...
						_jwalter$project$Main$httpErrorMessage(_p1._0),
						org),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _jwalter$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _jwalter$project$Main$init, view: _jwalter$project$Main$view, update: _jwalter$project$Main$update, subscriptions: _jwalter$project$Main$subscriptions})
};
var _jwalter$project$Main$MorePlease = {ctor: 'MorePlease'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _jwalter$project$Main$main === 'undefined' ? null : _jwalter$project$Main$main);
